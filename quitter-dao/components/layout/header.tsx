              ...
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <Link href='/'>
                      <a><img className="h-8 w-auto sm:h-10" src="https://s2.loli.net/2022/05/03/jOTnPvoI9ksxRyK.png"/></a>                      
                    </Link>
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                  <Link href={`/roadmap`}><button ><a className="font-medium text-gray-500 hover:text-gray-900"> Roadmap</a></button></Link>

                  {/* <Link href={'/community'}><button><a className="font-medium text-gray-500 hover:text-gray-900">Community</a></button></Link> */}

                  <Link href='/mint'>
                    <a className="items-center justify-center border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-2 md:text-lg md:px-4"> Mint NFT </a>
                    </Link>
